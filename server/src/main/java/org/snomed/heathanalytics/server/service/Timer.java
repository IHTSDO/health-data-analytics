...
public class Timer {
	...
	private final Timer childTimer;

	public Timer(String timerName) {
		this(timerName, Level.INFO);
	}

	public Timer(String timerName, Level loggingLevel) {
	 ...
	 */
	public Timer(String timerName, Level loggingLevel, float durationLoggingThreshold) {
		this(timerName, loggingLevel, durationLoggingThreshold, null);
	}

	public Timer(String timerName, Level loggingLevel, float durationLoggingThreshold, Timer childTimer) {
